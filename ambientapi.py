# from https://github.com/avryhof/ambient_api/blob/master/ambient_api/ambientapi.py
#
# last modified 22 June 2020, current as of 1 May 2021
#
# Original Author: hithub.com/avryhof
#
# MIT License
